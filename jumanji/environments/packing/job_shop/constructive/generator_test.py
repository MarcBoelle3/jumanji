...
class TestDummyGenerator:
    ...
    def test_dummy_generator__call(
        self, dummy_generator: DummyGenerator, dummy_scenario_generator: DummyScenarioGenerator
    ) -> None:
...
class TestToyGenerator:
    ...
    def test_toy_generator__call(
        self, toy_generator: ToyGenerator, toy_scenario_generator: ToyScenarioGenerator
    ) -> None:
